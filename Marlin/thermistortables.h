...
#if (THERMISTORHEATER_0 == 73) || (THERMISTORHEATER_1 == 73) || (THERMISTORHEATER_2 == 73) || (THERMISTORBED == 73) // epcos B57550G1104 100k
// ./createTemperatureLookup.py --rp=4700 --t1=25.0:100000.0 --t2=150.0:1642.0 --t3=250.0:226.0 --num-temps=36 --rs=0
...
#if (THERMISTORHEATER_0 == 74) || (THERMISTORHEATER_1 == 74) || (THERMISTORHEATER_2 == 74) || (THERMISTORBED == 74) // epcos B57550G103J 10k
// Thermistor lookup table for Marlin
// ./createTemperatureLookupMarlin.py --rp=4700 --t1=25.0:10000.0 --t2=150.0:266.12 --t3=250.0:47.79 --num-temps=36
// Steinhart-Hart Coefficients: 0.000915000340526971, 0.000256183906239582,  1.0171948472087e-07
//#define NUMTEMPS 36
